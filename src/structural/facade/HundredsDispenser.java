...
public class HundredsDispenser implements MoneyDispenser {
    private long numberOfNotes;
    final static private double VALUE_PER_NOTE = 100;

    HundredsDispenser(long numberOfNotes) {
    ...
    public double getCurrencyItem(long requestedNotes) {
       final double dispensedNotes = dispense(requestedNotes);
